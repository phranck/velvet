 ...
 */
const attributionsOutDir = resolve(import.meta.dirname, "dist-website/attributions");
...
export default defineConfig({
  ...
  plugins: [
    phosphorWoff2Only,
    svelte(),
    renameHtmlEntry("attributions.html"),
