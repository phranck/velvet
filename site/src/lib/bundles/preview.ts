 ...
 *
 * The shape is the host's: the language, the viewport, the element the design
 ...
 *
 * @param options - The design's name, its markup and its stylesheet.
 * @returns A complete document, ready to be given to `srcdoc`.
 */
export function bundlePreviewDocument(options: BundlePreviewOptions): string {
  return `<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
