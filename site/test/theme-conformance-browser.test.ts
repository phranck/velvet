 ...
 * The suite renders each theme's template here and themes each theme's script
 * with `Bun.build`, so the same foundation module is both loaded into this runtime
...
test(
  "every theme conforms against every fixture",
  async () => {
