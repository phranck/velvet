 ...
 *
 * Stated here rather than read out of a stylesheet, because a `@font-face` names
 * a file that has to exist before the stylesheet is read, and a list derived
 * from the thing it is meant to produce cannot catch a face nobody copied.
 */
const BUNDLES: Record<string, Face[]> = {
  velvet: [
