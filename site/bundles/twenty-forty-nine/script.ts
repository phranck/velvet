/**
 * What Twenty Forty-Nine does once its markup is on the page.
 *
 ...
 * track, barely rounded, with no gloss on them. A meter rather than a bar,
 * which is what a readout of this period shows.
 */
...
/**
 * The plot: taller than the page Velvet publishes, five rules rather than
 * three, and a thin trace over a faint wash. It prints no scale of ticks, so
 * their lengths are nought.
 */
