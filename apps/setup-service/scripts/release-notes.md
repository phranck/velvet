...
Beyond that, this release removes the analytics setting from the configuration, lets an installation appear in the public list at velvet.li/references when its owner says so, shows the installation's number on the status page, and drops everything Velvet had for reading Upptime data.
