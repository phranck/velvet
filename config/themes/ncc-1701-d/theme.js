...
// theme-bundles/ncc-1701-d/script.ts
var STRIP_GEOMETRY = {
  height: 26,
  hoverHeight: 34,
  gap: 2,
...
function enhance(root, data) {
  const page = root.querySelector(".ncc-1701-d-page") ?? root;
  const undo = [];
  const rows = [];
...
// theme-bundles/ncc-1701-d/format.ts
var RANGES2 = [
...
// theme-bundles/ncc-1701-d/template.ts
var HEADLINE = {
