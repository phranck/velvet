...
export const validateInstallationConfiguration = (
  value: unknown,
): SetupContractValidationResult<InstallationConfiguration> =>
  validatePublicContract(InstallationConfigurationSchema, value);
